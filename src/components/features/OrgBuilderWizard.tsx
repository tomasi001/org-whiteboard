  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <Card className="w-full max-w-4xl mx-4 h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="border-b border-white/20 px-4 py-2 flex-shrink-0 bg-black/20 backdrop-blur-md">
                ...
                <div key={step.id} className="flex items-center">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 py-1 rounded text-xs transition-colors ${
                      isActive
                        ? "bg-cardzzz-cream text-cardzzz-accent font-medium"
                        : isComplete
                          ? "text-cardzzz-cream"
                          : "text-cardzzz-cream/60"
                    }`}
                  >
                    <Icon className="w-3.5 h-3.5" />
                    <span className="hidden sm:inline font-roundo lowercase">{step.label}</span>
                  </button>
                  {index < STEPS.length - 1 && (
                    <ArrowRight className="w-3 h-3 mx-1 text-cardzzz-cream/40" />
                  )}
                </div>
              );
            })}
        ...
        {suggestedGaps.length > 0 && (
          <div className="px-4 py-2 bg-cardzzz-accent/35 border-b border-white/20 flex-shrink-0">
            <div className="flex items-center gap-2 text-xs text-cardzzz-cream font-satoshi">
        ...
        <div className="border-t border-white/20 p-4 flex-shrink-0 bg-black/20 backdrop-blur-md">
